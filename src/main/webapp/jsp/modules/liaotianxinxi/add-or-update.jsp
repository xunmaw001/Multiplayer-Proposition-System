		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑聊天信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">聊天信息管理</li>
								<li class="breadcrumb-item active">编辑聊天信息</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">聊天信息信息</h3>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="biaoti" name="biaoti" class="form-control" placeholder="标题">
											...
											<div class="form-group col-md-6">
										<label>聊天内容</label>
										<textarea name="liaotianneirong" class="form-control" id="liaotianneirong" rows="3"></textarea>
									</div>
											<div class="form-group col-md-6">
										<label>日期</label>
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#biaoti").val(ruleForm.biaoti);	
																$("#liaotianneirong").val(ruleForm.liaotianneirong);
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.liaotianneirong != null && res.data.liaotianneirong != ''){
															...
															$("#liaotianneirong").val(res.data.liaotianneirong);
													}
