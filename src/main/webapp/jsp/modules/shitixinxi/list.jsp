...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">试题信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">试题信息列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">试题信息列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
			...
			row.appendChild(checkbox)
				  ...
				  tupianCell.appendChild(tupianImg);
									...
									row.appendChild(tupianCell);
				            				var shijuanwenjianCell  = document.createElement('td');

												  var shijuanwenjianFile = document.createElement('button');
				  shijuanwenjianFile.innerHTML = '下载';
				  var shijuanwenjianFileAttr = "download('" + item.shijuanwenjian + "')"
				  shijuanwenjianFile.setAttribute('onclick',shijuanwenjianFileAttr);
                  shijuanwenjianCell.appendChild(shijuanwenjianFile);

                
									row.appendChild(shijuanwenjianCell);
            ...
            crossBtn1.innerHTML = "提交试卷"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"shijuantijiao\")");
			if(crossBtnControl('提交试卷') == true){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shitixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"shitixinxi");
