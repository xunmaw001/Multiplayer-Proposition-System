				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>试卷文件：</span>
							<span class="desc">
								<a download="shijuanwenjian" :href="detail.shijuanwenjian">点击下载</a>
							</span>
						</div>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('shitixinxi','提交试卷')" @click="onAcrossTap('shijuantijiao')" type="button" class="layui-btn">
								提交试卷
							</button>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`shitixinxi`);
