        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">试题信息展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
            ...
            <form class="layui-form">
              <div class="layui-inline" style="margin-bottom: 10px;">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="timu" id="timu" placeholder="题目" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">科目</label>
                <div class="layui-input-inline">
                  <input type="text" name="kemu" id="kemu" placeholder="科目" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                ...
                <button v-if="isAuth('shitixinxi','新增')" @click="jump('../shitixinxi/add.jsp')" type="button" class="layui-btn btn-theme">
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../shitixinxi/detail.jsp?id='+item.id)">
                    ...
                    <div class="ng-prslist-tit" @click="jump('../shitixinxi/detail.jsp?id='+item.id)"><span>{{item.timu}}</span></div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#timu').val()) {
          param['timu'] = jquery('#timu').val() ? '%' + jquery('#timu').val() + '%' : '';
        }  
        if (jquery('#kemu').val()) {
          param['kemu'] = jquery('#kemu').val() ? '%' + jquery('#kemu').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('shitixinxi/list', 'get', param, function(res) {
