...
<body>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-assist">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">学校公告展示</span>
          ...
          <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
            <div class="ng-incontlst-doc ng-incontlst-doc-show">
              <div class="row">
                <div class="ng-incontlst-col" v-for="(item,index) in xuexiaogonggaoList" v-bind:key="index">
                  <div class="ng-incontlst-bor">
                    <div class="ng-incontlst-img ng-oa ng-fault">
                      <a href="javascript:void(0);" @click="jump('../xuexiaogonggao/detail.jsp?id='+item.id)">
                    ...
                    <div class="ng-fault ng-container">
                      ...
                      <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../xuexiaogonggao/detail.jsp?id='+item.id)">查看详情</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-assist">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">试题信息展示</span>
              <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
            <span class="ng-inmod-thebor" aos="fade-up"></span>
          </div>
          ...
          <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
            <div class="ng-incontlst-doc ng-incontlst-doc-show">
              <div class="row">
                <div class="ng-incontlst-col" v-for="(item,index) in shitixinxiList" v-bind:key="index">
                  <div class="ng-incontlst-bor">
                    <div class="ng-incontlst-img ng-oa ng-fault">
                      <a href="javascript:void(0);" @click="jump('../shitixinxi/detail.jsp?id='+item.id)">
                        <img :src="item.tupian?item.tupian.split(',')[0]:''" />
                      </a>
                    </div>
                    <div class="ng-fault ng-container">
                      ...
                      <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../shitixinxi/detail.jsp?id='+item.id)">查看详情</a>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <script type="text/javascript">
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`xuexiaogonggao/list`, 'get', {
        page: 1,
        limit: 10
      }, function(res) {
        vue.xuexiaogonggaoList = res.data.list;
        vue.$nextTick(()=>{
          window.xznResize();
        });
      });
      http.request(`shitixinxi/list`, 'get', {
        page: 1,
        limit: 10
      }, function(res) {
        vue.shitixinxiList = res.data.list;
        vue.$nextTick(()=>{
          window.xznResize();
        });
      });
