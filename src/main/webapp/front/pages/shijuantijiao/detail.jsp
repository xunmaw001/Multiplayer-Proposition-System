				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>上交试卷：</span>
							<span class="desc">
								<a download="shangjiaoshijuan" :href="detail.shangjiaoshijuan">点击下载</a>
							</span>
						</div>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('shijuantijiao','批改')" @click="onAcrossTap('shijuanpigai')" type="button" class="layui-btn">
								批改
							</button>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`shijuantijiao`);
